...
export const MovingGrid = ({translateXOffset = 0, direction = 1, color = "#E53E3E"}) => {
    ...
    return <Box 
            ...
            content="''" display="block" position="absolute" bottom={0} left={"-50%"} right={0} width="200%" height="100%"
            padding={1}
            ...
            backgroundImage={`linear-gradient(to right, ${color} 1px, transparent 1px), linear-gradient(to bottom, ${color} 1px, transparent 2px)`}
        ></Box>
}